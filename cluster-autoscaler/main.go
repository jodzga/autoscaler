...
var (
	...
	scaleDownIgnorePDB = flag.Bool("scale-down-ignore-pdb", false, "If true, cluster-autoscaler will ignore PDBs and may evict pods violating PDBs during scale-down by directly deleting pods. This flag does not affect pods controlled by StatefulSets - Cluster Autoscaler will evict pods controlled by StatefulSets only if it doesn't violate their PDBs.")
)
